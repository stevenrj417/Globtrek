...
export function mapHotel(row, destination) {
  return {
    ...
    providerUrl: row.provider_link_verified ? row.provider_url || null : null,
    bookingUrl: row.provider_link_verified ? row.booking_com_property_url || null : null,
    cjTrackingBaseUrl: row.provider_link_verified ? row.cj_tracking_url || null : null,
