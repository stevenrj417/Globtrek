...
function label(value) { return value ? `${value.city || value.airportName}${value.airportCode ? ` (${value.airportCode})` : ""}` : ""; }

export function StartingLocationField({ value, onChange, id = "starting-location" }) {
