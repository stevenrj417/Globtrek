...
const trips = [
  { name: "Kyoto", country: "Japan", price: "Est. $4,850–$6,400", image: "/kyoto-feature.jpg", alt: "A quiet tree-lined street in Kyoto" },
  { name: "Amalfi Coast", country: "Italy", price: "Est. $5,900–$8,200", image: "/amalfi-feature.jpg", alt: "Lemon trees overlooking the Amalfi Coast at sunset" },
  { name: "Banff", country: "Canada", price: "Est. $3,750–$5,600", image: "/banff-feature.jpg", alt: "A grand hotel surrounded by forest and mountains in Banff" },
];
      ...
      <section id="trips" className="reveal border-t border-black/10 py-20 sm:py-28">
        <div className="mx-auto max-w-[1520px] px-5 sm:px-8">
          ...
          <div className="grid gap-x-6 gap-y-12 md:grid-cols-3 lg:gap-x-8">
            {trips.map((trip) => (
              <Link href="/discover" className="group block" key={trip.name}>
